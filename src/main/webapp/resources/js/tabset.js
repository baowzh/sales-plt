...
function TabSet(outerElmId, style) {
	...
	this.render = function() {
		...
		//ret[ret.length] = '<div id="' + this._outerElmId + 'gomove" style="float:right;display:inline;z-index:9998;"><a href="javascript:void(0)" class="tabgo"><img src="component/images/tabgoto.gif" alt="¸ü¶à..." width="12" height="20" border="0"/></a></div>';
