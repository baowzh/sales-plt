...
<body>
	...
	<div class="easyui-panel" style="width: 100%; height: 100%;" title="角色信息修改">
		<form id="updateRole" action="saveRole.jhtml" method="post">
			<table align="center" style="width: 90%;">
				<tr>
					<td align="right" width="40%"><input class="easyui-textbox"
						name="rightcode" style="width: 90%" 
						data-options="label:'角色编码： ',required:true,labelWidth:100,labelAlign:'right'"
				...
				<tr>
					...
					<select class="easyui-combobox"
						...
						style="width: 90%;" value="${role.roleAttr}" >
						<c:if test="${role.roleAttr == '0'}">
							<option value="0" selected>功能权限角色</option>
							<option value="1">数据权限角色</option>
						</c:if>
						<c:if test="${role.roleAttr == '1'}">
						
							<option value="0" >功能权限角色</option>
							<option value="1" selected >数据权限角色</option>
						</c:if>
						<c:if test="${role.roleAttr != '0' && role.roleAttr != '1'}">
							<option value="0" >功能权限角色</option>
							<option value="1" >数据权限角色</option>
						</c:if>
				...
				<tr>
					<td align="center" width="78%" colspan="3"><input class="easyui-numberbox"
